...
<head>
    <title><? echo lang('dashboard'); ?> | Cangkruk</title>
    <admin charset="UTF-8">
    <admin name="description" content="Cangkruk adalah platform jejaring sosial untuk membantu Anda bertemu teman baru, terus terhubung dengan keluarga dan menjaga hubungan baik dengan orang-orang yang Anda sayangi.">
