...
<head>
    <title><? echo lang('welcome'); ?> | Cangkruk</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="homepage,main,login,social network,social media,Cangkruk,meet">
    ...
    <!--============[ Nav bar ]============-->
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> Cangkruk</h3>
        ...
        <div class="footer-index" align="center">
