...
$.ajax({
    ...
    success:function(data){
     if (data =='') {
        $('#m_contacts_friends').html("<p style='margin: 0px 8px; text-align: center; color: white; background: rgb(135, 206, 250); padding: 8px 0px; border-radius: 10px;'><? echo lang('nothingToShow'); ?></p>");
     }else{
...
$.ajax({
    ...
    success:function(data){
     if (data =='') {
        $('#m_contacts_requests').html("<p style='margin: 0px 8px; text-align: center; color: white; background: rgb(135, 206, 250); padding: 8px 0px; border-radius: 10px;'><? echo lang('nothingToShow'); ?></p>");
     }else{
