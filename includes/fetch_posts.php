...
$body = nl2br("$body");
    ...
    <ul class='dropdown-menu ".lang('postDropdown')."' style='top:10px;color:#999;text-align: ".lang('postDropdownTxtAlign').";background:rgb(119, 136, 153);'>
    ";
    if ($get_author_id == $_SESSION['id']) {
            echo "
    <li><a href='javascript:void(0)' style='color:white;' onclick=\"editPost('$get_post_id')\"><span class='fa fa-pencil' style='color:white;'></span> ".lang('EditPost_DDM')."</a></li>
    <li><a href='javascript:void(0)' style='color:white;' onclick=\"deletePost('$get_post_id')\"><span class='fa fa-trash-o' style='color:white;'></span> ".lang('DeletePost_DDM')."</a></li>
    <li class='divider'></li>";
        }
    echo "
    <li><a href='javascript:void(0)' style='color:white;' onclick=\"savePost('$get_post_id','$check_path')\"><span class='fa fa-bookmark' style='color:white;'></span> ".lang('savePost_DDM')."</a></li>
    <li><a href='javascript:void(0)' style='color:white;' onclick=\"reportpost('post','$get_post_id')\"><span class='fa fa-bug' style='color:white;'></span> ".lang('reportPost_DDM')."</a></li>
    </ul>
    </div>
    </td>
    </tr>
    ...
    <select id='p_privacy_$get_post_id' style='padding: 8px 10px; border-radius: 10px;background: rgb(135, 206, 250);color:white;border:none;'>
...
$c_num = $c->rowCount();
if ($c_num > 0){
    echo "<span id='likeUnlike_$get_post_id' style='cursor:pointer'><span onclick=\"likeUnlike('$get_post_id')\" style='color:#ff928a;font-size:20px' data-toggle='tooltip' data-placement='top' title='".lang('u_liked_this')."' id='punlike'><span class=\"fa fa-heart\"></span></span></span>";
}else{
    echo "<span id='likeUnlike_$get_post_id' style='cursor:pointer'><span onclick=\"likeUnlike('$get_post_id')\" style='color:#ff928a;font-size:20px' data-toggle='tooltip' data-placement='top' title='".lang('liked')."' id='plike'><span class=\"fa fa-heart-o\"></span></span></span>";
}
