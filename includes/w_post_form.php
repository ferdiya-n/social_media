...
<ul class="wpost_tab">
    ...
    <li style="float:<?php echo lang('w_post_li2'); ?>;">
        <select id="p_privacy" style="margin: 5px; padding: 0px 10px; max-width: 110px; height: 35px;color: white; border-radius: 10px; background-color: rgb(135, 206, 250);border: none;" name="w_privacy">
