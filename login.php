...
<head>
    <title><? echo lang('login'); ?> | Cangkruk</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="login,social network,social media,Cangkruk,meet">
    ...
    <!--============[ Nav bar ]============-->
        ...
        <div align="center">
            ...
            <div style="background: #fff; border-radius: 6px; max-width: 350px; padding: 15px; margin:auto;margin-top: 15px;color: #7b7b7b;" align="center">
