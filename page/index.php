...
switch ($page) {
case 'supportbox':
$pagename = lang('supportBox');
break;
case 'report':
$pagename = lang('Report_A_Problem');
break;
default:
...
<head>
    <title><?php echo $pagename; ?> | Cangkruk</title>
    <meta charset="UTF-8">
...
<body onload="fetchPosts_DB('user')" style="background: var(--dark);">
<!--=============================[ NavBar ]========================================-->
...
<div align="center" style="margin-top: 54px; padding: 3%;">
	<div align="left">
	<div class="contentBox" style="margin-bottom: 15px;border-radius: 10px;"><p style="text-align:<?php echo lang('textAlign'); ?>;margin: 0px;padding: 10px 15px;"><span style="padding: 10px 15px;border-bottom: 3px solid var(--light);"><?php echo lang('supportBox'); ?></span></p></div>
		...
		if($countReports < 1){echo "<div style='width: 100%;margin-bottom: 15px;padding:15px;color:#999;border-radius: 10px;' class='contentBox'>".lang('nothingToShow')."</div>";}
...
<div align="center" style="margin-top: 54px; padding: 3%;">
	<div align="left">
	<div class="contentBox" style="margin-bottom: 15px;border-radius: 10px;"><p style="text-align:<?php echo lang('textAlign'); ?>;margin: 0px;padding: 10px 15px;"><span style="padding: 10px 15px;border-bottom: 3px solid #2196f3;"><?php echo lang('Report_A_Problem'); ?></span></p></div>
		<div style="text-align:<?php echo lang('textAlign'); ?>;display: flex; max-width: 830px; margin: auto;">
		<div style="width: 100%; margin: 0px 15px;">
		<div class="contentBox" style="padding: 15px;border-radius: 10px;">
