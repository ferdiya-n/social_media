...
<head>
    <title><?php echo lang('accountSetup'); ?> | Cangkruk</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="settings,social network,social media,Cangkruk,meet">
    <meta name="author" content="Muhammad Ferdiyan Permata">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <?php include "includes/head_imports_main.php";?>
</head>
<body style="overflow-y: scroll;background: rgb(119, 136, 153);">
<!--=============================[ NavBar ]========================================-->
...
<div style="width: 300px;background: white;margin: 5px;border-radius: 10px;box-shadow: 0px 0px 18px rgba(63, 81, 181, 0.16);">
...
<div id="Language" class="tabcontent" style="height: auto;">
    ...
    <form action="" method="post">
        ...
        <select class="settings_textfield" name="edit_language">
            <option <?php if($_SESSION['language'] == "indonesia"){ echo "selected";} ?> >Indonesia</option>
...
<form action="" method="post">
    <div>
    <p style="background: rgb(135, 206, 250); color: white; padding: 15px; border-radius: 10px;"><?php echo lang('remove_account_note'); ?></p>
    ...
    <p style="margin: 0px;"><input class="red_flat_btn" name="removeA_save_changes" type="submit" value="<?php echo lang('remove_account'); ?>" /></p>
    </div>
