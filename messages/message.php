...
<head>
    <title><? echo lang('messages'); ?> | Cangkruk</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="Notifications,social network,social media,Cangkruk,meet">
    <meta name="author" content="Muhammad Ferdiyan Permata">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <?php include "../includes/head_imports_main.php";?>
</head>
<body style="background: rgb(119, 136, 153);">
<!--=============================[ NavBar ]========================================-->
    ...
    <div style="text-align: <? echo lang('textAlign'); ?>">
    	<div class="messages">
    		...
    		<div class="mCol3_userInfo">
    			...
    			<h4 style="text-align: center;"><div style="width: 60%; height: 10px; background: rgb(135, 206, 250); margin: auto;"></div></h4>
    			<p style="text-align:center;margin: 0px;color: gray"><div style="width: 40%; height: 10px; background: rgb(135, 206, 250); margin: auto;"></div></p>
    		</div>
    		<div class="mCol3_bio" style="text-align:<? echo lang('textAlign'); ?>;">
    			<div style="width: 80%; height: 10px; background: rgb(135, 206, 250);"></div>
    			<div style="width: 60%; height: 10px; background: rgb(135, 206, 250);margin-top: 8px;"></div>
    		</div>
    		</div>
    	</div>
    </div>
