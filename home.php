...
<head>
    <title><?php echo lang('navbar_home'); ?> | Cangkruk</title>
    <meta charset="UTF-8">
...
<body onload="fetchPosts_DB('home');" style="background-color: var(--dark);">
<!--=============================[ NavBar ]========================================-->
...
<?php
 echo "<span style='cursor:pointer;width:95%;display:inline-flex;margin:5px;'><a href='settings?tc=edit_profile' class=\"silver_flat_btn\" style='color:white;width:80%;border-radius:10px;'><span class=\"fa fa-cog\"></span> ".lang('edit_profile')."</a></span>";
?>
</div>
<a href="./u/<?php echo $_SESSION['Username']; ?>&ut=photos"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/gallery.png" /> <?php echo lang('my_photos'); ?></p></a>

<a href="./mynotepad/new"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/note.png" /> <?php echo lang('new_note'); ?></p></a>
<?php
$msid = $_SESSION['id'];
...
?>
<a href="./mynotepad/"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/read.png" /> <?php echo lang('see_all_notes')."<span>".thousandsCurrencyFormat($notesCount)."</span>"; ?></p></a>
...
?>
<a href="./u/<?php echo $_SESSION['Username']; ?>&ut=stars"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/star.png" /> <?php echo lang('see_all_notes'); ?></p></a>

<a href="./posts/saved"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/save.png" /> <?php echo lang('saved_posts'); ?></p></a>
    </div>
        </div>
    </div>
<!--======================[ end Center col1 ]=============================-->
        ...
        <div align="left">
            ...
            <!--==========[ End Account Setup ]=========-->
                ...
                <div class="post  loading-info" id="NoMorePostsDiv" style="display: none;">
                  <p style="color: black;text-align: center;padding: 15px;margin: 0px;font-size: 18px;"><?php echo lang('noMoreStories'); ?></p>
                </div>
...
<!--====================================[ Center col3 ]============================================-->
        <div align="left">
         <div id="centerCol3" style="width: 310px">
          ...
          <div class="trendingTitle_CenterCol_3" style="background: rgb(135, 206, 250);"><a href="#" id="trPagesTab" style="background: ;"><?php echo lang('pages'); ?></a> <a href="#" id="trPostsTab"><?php echo lang('posts'); ?></a></div>
