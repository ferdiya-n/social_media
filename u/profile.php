...
<head>
    <title><?php echo $row_username; ?> | Cangkruk</title>
    <meta charset="UTF-8">
    ...
    <body onload="fetchPosts_DB('user')" style="background: rgb(119, 136, 153);">
<!--=============================[ NavBar ]========================================-->
...
<!--=============================[ Container ]=====================================-->
        ...
        <div class="profile_picture_img profile_ppicture" style="<?php echo $profile_pic_border_var;?>">
            ...
            if($_SESSION['Username'] == $row_username){
                ...
                background:rgb(135, 206, 250, 0.8);width: 100%;border-radius: 10px;padding: 2px;color: #fff;margin-top:10px;'> <span style='font-family: sans-serif;'>".lang('save')."
